...
const FeaturedSection2 = () => {
        ...
        >
            ...
            <div className="absolute top-0 left-0 z-10 w-full md:w-1/2 h-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center items-center text-center bg-[#F4E3D7]/90 backdrop-blur-lg">
                ...
                <p className="text-sm sm:text-base md:text-sm lg:text-base text-[#1F2F3C] leading-relaxed max-w-[90%]">
                    Experience a new standard of living with exclusive residences designed for sophistication and comfort. With impeccable craftsmanship, modern amenities, and elegant designs, our homes offer a harmonious blend of luxury and tranquility, ensuring an unparalleled lifestyle.
                </p>
            </div>
    ...
    <div className="max-w-xl">
        <h2 className="text-2xl mr-10 sm:text-3xl md:text-4xl font-serif text-[#1F2F3C] mb-4">
            PREMIUM LIFESTYLE
        </h2>
                    <p className="text-sm sm:text-base md:text-sm lg:text-base text-[#1F2F3C] leading-relaxed max-w-[90%]">
